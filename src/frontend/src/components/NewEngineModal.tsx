  ...
  return (
    <Dialog open={open} onOpenChange={(v) => !v && handleClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="font-display">New Cloud Engine</DialogTitle>
          <DialogDescription>
        ...
        <div className="space-y-5 py-1">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-mono font-bold">{cpu} cores</span>
            </div>
            <Slider
              min={1}
              max={64}
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-mono font-bold">{storage} GB</span>
            </div>
            <Slider
              min={10}
              max={2000}
          ...
          <Tooltip>
            ...
            <TooltipContent side="bottom" className="max-w-64">
              <p>
                ...
                engine can move across AWS, GCP, and Azure instantly — you own
                your infrastructure.
              </p>
            </TooltipContent>
          </Tooltip>
            ...
            <div className="flex items-start gap-2.5 p-3 rounded-lg bg-[oklch(0.72_0.18_55/0.1)] border border-[oklch(0.72_0.18_55/0.3)]">
              ...
              <div className="flex-1">
                <p className="text-xs text-[oklch(0.82_0.18_55)]">
                  You've reached the Free tier limit (1 engine). Upgrade to Pro
                  to create unlimited engines.
                </p>
                {onOpenPricing && (
                  <button
                    type="button"
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={isPending || atEngineLimit}
            className="gap-2"
          >
