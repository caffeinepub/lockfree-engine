      ...
      <section className="relative z-10 py-16 px-5 sm:px-8 md:px-12 border-y border-border/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            <div className="flex flex-col gap-4 p-6 rounded-xl bg-card/30 border border-border/40 border-l-4 border-l-indigo-500/70 backdrop-blur-sm">
            ...
            <div className="flex flex-col gap-4 p-6 rounded-xl bg-card/30 border border-border/40 border-l-4 border-l-cyan-500/70 backdrop-blur-sm">
            ...
            <div className="flex flex-col gap-4 p-6 rounded-xl bg-card/30 border border-border/40 border-l-4 border-l-emerald-500/70 backdrop-blur-sm">
