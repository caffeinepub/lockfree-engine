                ...
                {[
                  {
                    ...
                    content: (
                      <div className="space-y-2">
                        <p>
                          Migrating to the cloud means moving your apps, data,
                          and systems from traditional servers — whether
                          on-premise or hosted on AWS, Azure, or Google Cloud —
                        ...
                        <p>
                          ...
                          single provider&apos;s infrastructure. No single
                          company owns the hardware your business runs on.
                        </p>
                        <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-2">
                  ...
                  },
                  {
                    ...
                    content: (
                      <div className="space-y-2">
                        ...
                        <p>
                          ICP Cloud Engines are designed for portability from
                          day one. You can:
                        </p>
                        <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-2">
                          <li>
                  ...
                  },
                  {
                    ...
                    content: (
                      <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground">
                          No command line. No cloud certifications required.
                          Just a clean dashboard built for both technical and
                          non-technical teams.
                        </p>
                      </div>
                    ),
                  },
                  {
                    ...
                    content: (
                      <div className="space-y-2">
                        <p>
                          LockFreeEngine is live on ICP and Caffeine v3.0
                          launched on April 7th. Cloud Engines are in production
                          on the NNS — the infrastructure this app is built to
                          manage already exists. Third-party developer access
                          opens as DFINITY onboards independent node providers.
                        </p>
                        <p>
                        ...
                        <ol className="list-decimal list-inside space-y-1 text-muted-foreground ml-2">
                          <li>
                            Join the waitlist on the landing page for early
                            access priority
                          </li>
                          <li>
                        ...
                        <p className="text-muted-foreground mt-2">
                          Already signed in? Explore the dashboard in Demo Mode
                          to see exactly how LockFreeEngine works before
                        ...
                        <div className="mt-3 rounded-lg border border-primary/25 bg-primary/5 px-4 py-3 flex gap-3">
                          ...
                          <div className="text-xs text-foreground/80 leading-relaxed space-y-1">
                            ...
                            <p>
                              Snorkel will automate the technical migration
                              steps — analysing your existing stack, mapping
                            ...
                            <p>
                              ...
                              language — no command-line tools, no
                              infrastructure expertise required. Business owners
                              can initiate a migration the same way they'd send
                              a chat message.
                            </p>
                          </div>
                        </div>
              ...
              <div className="mb-4 rounded-lg border border-primary/30 bg-primary/5 overflow-hidden">
                ...
                <div className="px-4 py-3 space-y-2 text-xs text-foreground/80 leading-relaxed">
                  ...
                  <ol className="list-decimal list-inside space-y-1 ml-2 text-foreground/70">
                    ...
                    <li>
                      <strong>Snorkel migrates</strong> — Your legacy codebase
                      is analysed, dependencies resolved, ICP-compatible
                      deployment generated automatically
                    </li>
                    <li>
                  ...
                  <p className="text-muted-foreground">
                    Until Snorkel ships, use the steps below to migrate
                    manually. The AI Deploy Chat already simulates the Snorkel
                    conversation flow — try describing a legacy app to see what
                    the automated path will look like.
                  </p>
                </div>
              </div>
              <Accordion type="multiple" className="space-y-2">
                {[
                  {
                    ...
                    content: (
                      <div className="space-y-2">
                        <p>
                          Before writing a single line of migration code, build
                          a complete inventory of your current infrastructure.
                          This drives your entire migration plan.
                        </p>
                        ...
                        <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-2">
                          ...
                          <li>
                            <strong>File storage:</strong> S3 buckets, GCS,
                            Azure Blob — note file types, sizes, and access
                            patterns
                          </li>
                          <li>
                            <strong>Background jobs:</strong> Cron tasks,
                            queues, and event-driven workflows
                          </li>
                        </ul>
                        <p className="text-muted-foreground">
                          Prioritise the smallest, most self-contained service
                          for your first migration. A clean success builds team
                          confidence.
                        </p>
                      </div>
                    ),
...
mongoexport --db mydb --collection users --out users.json`}</code>
                        ...
                        <p className="text-muted-foreground">
                          Strip nulls, normalise timestamps to Unix
                          milliseconds, and ensure IDs are strings — Motoko uses{" "}
                          <code className="text-xs bg-muted px-1 rounded">
                            Text
                          </code>{" "}
...
// e.g. https://<canister-id>.raw.ic0.app/blob/<id>`}</code>
                        ...
                        <p className="text-muted-foreground">
                          For large media files (video, high-res images), the
                          blob storage component handles chunking automatically
                    ...
                    content: (
                      <div className="space-y-2">
                        <p>
                          ...
                          canister ID becomes your permanent backend address —
                          no servers to manage, no uptime to monitor.
                        </p>
                        <pre className="text-xs bg-muted/60 border border-border rounded-lg p-3 overflow-x-auto font-mono leading-relaxed mt-2">
                    ...
                    content: (
                      <div className="space-y-2">
                        ...
                        <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-2">
                          ...
                          <li>
                            Migration between providers (AWS → GCP → Azure)
                          </li>
                          <li>
                        ...
                        <div className="mt-3 p-3 rounded-lg border border-primary/30 bg-primary/5">
                          <p className="text-sm font-medium text-primary">
                            As third-party access to the Cloud Engines API
                            opens, your setup will automatically unlock
                            dedicated subnet resources — no reconfiguration
                            required.
                          </p>
